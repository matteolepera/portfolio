...
export default function About() {
    return (
        <>
            <Helmet>
                <title>Matteo Le Pera | Bio</title>
                <meta name="description" content="Chi sono, il mio percorso da Junior Full Stack Web Developer e le tecnologie con cui lavoro ogni giorno." />
            </Helmet>
